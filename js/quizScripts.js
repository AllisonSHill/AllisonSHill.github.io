...
function buildQuiz() {
    ...
    myQuestions.forEach(
        (currentQuestion, questionNumber) => { // currentQuestion is the current value, questionNumber is the index in the array
            ...
            var pictureArray = [
                '<img src=./images/quizImages/0.jpg id = 0 height = 350>',
                '<img src=./images/quizImages/1.jpg id = 1 height=350>',
                '<img src=./images/quizImages/2.jpg id = 2 height=350>',
                '<img src=./images/quizImages/3.jpg id = 3 width = 500>',
                '<img src=./images/quizImages/4.jpg id = 4 height=350>',
                '<img src=./images/quizImages/5.jpg id = 5 height=350>',
                '<img src=./images/quizImages/6.jpg id=6 height=350>',
                '<img src=./images/quizImages/7.jpg id=7 height=350>',
                '<img src=./images/quizImages/8.jpg id=8 height=350>',
                '<img src=./images/quizImages/9.jpg id=9 height=350>'
